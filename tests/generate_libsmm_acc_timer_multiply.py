...
def main(
    ...
    """
    Generate a performance test of libsmm_acc in the form of a CUDA or HIP file, using libsmm_acc_timer_multiply.cpp.template as a template
    """
    ...
    # Print to test file
    file_template = os.path.join(test_template_dir, "libsmm_acc_timer_multiply.cpp.template")
